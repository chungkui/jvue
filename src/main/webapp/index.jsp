...
<head>
    ...
    <link title="" href="<%=contexPath%>/src/css/style.css" rel="stylesheet" type="text/css"/>
    <link title="blue" href="<%=contexPath%>/src/css/dermadefault.css" rel="stylesheet" type="text/css"/>
    <link title="green" href="<%=contexPath%>/src/css/dermagreen.css" rel="stylesheet" type="text/css" disabled="disabled"/>
    <link title="orange" href="<%=contexPath%>/src/css/dermaorange.css" rel="stylesheet" type="text/css" disabled="disabled"/>
    <link href="<%=contexPath%>/src/css/templatecss.css" rel="stylesheet" title="" type="text/css"/>
    ...
    <script src="<%=contexPath%>/src/js/jquery.cookie.js" type="text/javascript"></script>
...
--%>
    ...
    <script type="text/javascript" src="<%=contexPath%>/src/main.js">  </script>
</head>
    ...
    <nav class="nav navbar-default navbar-mystyle navbar-fixed-top">
        ...
        <div class="collapse navbar-collapse">
            ...
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="dropdown li-border"><a href="#" class="dropdown-toggle mystyle-color" data-toggle="dropdown">00000000@qq.com<span
                        class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="#">退出</a></li>
                    </ul>
            ...
            <div class="subNavBox">
                <div class="sBox">
                    <div class="subNav sublist-down"><span
                            class="title-icon glyphicon glyphicon-chevron-down"></span><span
                ...
                <div class="sBox">
                    <div class="subNav sublist-up"><span class="title-icon glyphicon glyphicon-chevron-up"></span><span
                            class="sublist-title">关于我们</span></div>
